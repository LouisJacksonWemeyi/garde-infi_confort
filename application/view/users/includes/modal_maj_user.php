<!-- line modal -->
<div class="modal fade" id="squarespaceModalupdateuser" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
  <div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
			<h3 class="modal-title" id="lineModalLabel">Mise à jour d'un utilisateur</h3>
		</div>
		<span>
			...
			<form id="form_update_user">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="password" class="form-control" id="exampleInputPassword" name="password" placeholder="Nouveau mot de passe">
              </div>
              <div class="form-group col-md-6">
                <label for="numero">Actif</label>
                <select name="actif" id="exampleInputActif">
              ...
              <button class="btn btn-default" id="btn_form_insert">Mettre à jour l'utilisateur</button>
              <span id="result_insert_user"></span>
            </form>
